...
import com.awbd.reteta.repository.FarmacistRepository;
...
public class FarmacistService {
    ...
    public Farmacist update(Long id, Farmacist updated) {
        ...
        if (updated.getDataAngajarii() != null) {
            existing.setDataAngajarii(updated.getDataAngajarii());
        }

        if (updated.getSalariu() != null) {
            existing.setSalariu(updated.getSalariu());
        }
