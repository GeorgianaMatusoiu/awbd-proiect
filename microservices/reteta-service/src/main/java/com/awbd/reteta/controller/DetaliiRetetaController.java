...
import com.awbd.reteta.service.DetaliiRetetaService;
...
public class DetaliiRetetaController {
    ...
    public DetaliiReteta getById(@PathVariable Long retetaId,
    ...
    public void delete(@PathVariable Long retetaId,
                       @PathVariable Long medicamentId) {
