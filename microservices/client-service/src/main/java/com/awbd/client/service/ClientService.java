...
public class ClientService {
    ...
    public Client update(Long id, Client updated) {
        ...
        if (updated.getNume() != null) {
            existing.setNume(updated.getNume());
        }

        if (updated.getPrenume() != null) {
            existing.setPrenume(updated.getPrenume());
        }

        if (updated.getVarsta() != null) {
            existing.setVarsta(updated.getVarsta());
        }

        if (updated.getTelefon() != null) {
