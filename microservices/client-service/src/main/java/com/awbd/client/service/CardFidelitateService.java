package com.awbd.client.service;

import com.awbd.client.dto.CardFidelitateRequest;
import com.awbd.client.entity.CardFidelitate;
import com.awbd.client.entity.Client;
import com.awbd.client.exception.BadRequestException;
import com.awbd.client.exception.ResourceNotFoundException;
import com.awbd.client.repository.CardFidelitateRepository;
import com.awbd.client.repository.ClientRepository;
...
public class CardFidelitateService {
    ...
    public CardFidelitate update(Long id, CardFidelitateRequest req) {
        ...
        if (req.getClientId() != null) {
            ...
            if (!existing.getClient().getId().equals(req.getClientId())
                    && cardRepo.existsByClientId(req.getClientId())) {
